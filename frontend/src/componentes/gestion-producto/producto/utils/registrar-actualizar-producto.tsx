...
export default function RegistrarActualizarProductoForm({
  ...
  useEffect(() => {
    if (costo !== undefined && porcentaje !== undefined) {
      const c = Number(costo) || 0;
      const p = Number(porcentaje) || 0;
      const calcPrecio = c + (c * p / 100);
      setValue("precio", calcPrecio);
    }
                  ...
                  <div className="col-span-full flex items-end gap-2">
                    <div className="flex-1">
                      <FormInput
                        ...
                        onKeyDown={enterToObservacion as any}
                    ...
                    <div className="flex-1">
                      <FormInput
                        name="presentacion"
                        label="Presentación"
                        placeholder="Ej: 1L, Pack x6, 500ml"
                        disabled={producto && producto.sistema > 0 ? true : false}
                        onKeyDown={enterToObservacion as any}
                      />
                    </div>
